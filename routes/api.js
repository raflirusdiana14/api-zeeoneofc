...
loghandler = {
    notparam: {
        ...
        getApikey: 'Mau Ampikey? Wa Ke 085794659953'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Apikey Unavailable / Error'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------RafliGanteng'+'ARASYA--GANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'RafliBid') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'RafliBid') return res.json(loghandler.invalidKey)
